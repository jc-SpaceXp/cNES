...
/* ADC & SUBC array operands */
int bin_operand1[8]; /* NES->A converted to binary */
int bin_operand2[8]; /* other operand in ADC or SUBC also in binary */
int bin_result[8]; /* result of ADC or SUBC is stored here */
...
void update_FLAG_C(uint8_t out);
